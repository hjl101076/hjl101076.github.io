...
<div>
<h2>3.구현</h2>
<h3 style="margin-left: 40px;">A. ROI 및 전처리</h3>
    <div>
    <img src="/assets/img/posts/hand-sub1.jpg"  width="50%" height="50%" style="margin-left: 40px; "/>
     <ul style=" float: right;">
      <li>a) Contour 알고리즘을 통해 영역을 분리, 저장</li>
      <br>
      <li>b) ConvexHull 알고리즘을 이용하여 손가락 사이의 골의  좌표를 획득</li>
      <br>
      <li>c) 좌표 계산을 통해 ROI(Region Of Interest)를 실행</li>
      <br>
    </ul>
   </div>
   <div>
...
<h3 style="margin-left: 40px;">B.손금 추출</h3>
<h3 style="margin-left: 40px;">C.데이터 처리 및 SIFT Matching</h3>
</div>
